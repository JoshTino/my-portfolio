	...
	return(
		...
		<>
			<div className="flex flex-col-reverse items-center md:flex-row md:justify-around md:w-11/12 gap-y-4 gap-x-7 m-auto p-4 my-7 lg:my-10">
				...
				<div className="">
					<h2 className="text-6xl w-fit font-inria font-bold italic md:text-5xl lg:text-6xl text-gray-800 mb-7">Hi there,</h2>
					...
					<h2 className="text-2xl font-inria font-bold italic md:text-2xl text-gray-800 bg-[#D9D9D9] rounded-r-3xl w-fit p-2 pr-5 mb-5">Full-Stack Web Developer</h2>
				...
				<div className="lg:w-10/12 flex flex-col">
					<div className="size-87 md:size-75 lg:size-130 self-end">
