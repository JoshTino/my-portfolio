    ...
    <>
      ...
      >
        ...
        >
          ...
          <h2 className="text-[31.5px] font-inria font-bold italic md:text-4xl lg:text-5xl shadow-xl shadow-gray-400/50 bg-red-200 rounded-r-3xl w-fit p-1 pr-5 mb-5">I am Dangana Joshua</h2>
