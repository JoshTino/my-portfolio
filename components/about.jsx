...
const About = () => {
	...
	return(
      ...
      >
				...
				<p className="text-center text-gray-800 font-inria leading-10 text-lg font-light md:w-180 md:my-4 lg:w-230">
				...
				<img src="/images/profile-img.jpg" className="w-120 my-2 shadow-lg/50" />
			</motion.div>
		</>
	);
