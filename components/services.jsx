...
const  Services = () => {
	...
	return(
		<>
			<div className="flex flex-col items-center m-auto mb-5 p-2" id="services">
				...
				<p className="md:w-9/12 font-inria leading-10 text-gray-800 font-light">Below are range of services I can render</p>
