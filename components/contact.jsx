...
const Contact = () => {
	return(
		<>
			<div className="flex flex-col mb-5 items-center p-4 md:m-auto" id="contact">
				...
				<div className="flex flex-col w-full md:w-9/12 md:flex-row md:justify-around">
					<div className="w-full mb-2 md:w-4/12">
						<div>
					...
					<div className="grid grid-cols-1 gap-3 md:w-8/12 md:grid-cols-2">
						...
						<button className="w-fit bg-black justify-self-center font-inria p-4 text-white self-center rounded-lg">Send Message</button>
					</div>
				</div>				
			</div>
		</>
